...
const DEFAULT_MILESTONE_REQUEST_SEND_WORKER_BOUND: usize = 10000;
const DEFAULT_TRANSACTION_SEND_WORKER_BOUND: usize = 10000;
const DEFAULT_TRANSACTION_REQUEST_SEND_WORKER_BOUND: usize = 10000;
const DEFAULT_HEARTBEAT_SEND_WORKER_BOUND: usize = 10000;
const DEFAULT_MILESTONE_VALIDATOR_WORKER_BOUND: usize = 10000;
const DEFAULT_TRANSACTION_SOLIDIFIER_WORKER_BOUND: usize = 10000;
const DEFAULT_MILESTONE_SOLIDIFIER_WORKER_BOUND: usize = 10000;
const DEFAULT_TRANSACTION_WORKER_BOUND: usize = 10000;
const DEFAULT_TRANSACTION_WORKER_CACHE: usize = 100000;
const DEFAULT_TRANSACTION_RESPONDER_WORKER_BOUND: usize = 10000;
const DEFAULT_MILESTONE_RESPONDER_WORKER_BOUND: usize = 10000;
const DEFAULT_TRANSACTION_REQUESTER_WORKER_BOUND: usize = 10000;
const DEFAULT_MILESTONE_REQUESTER_WORKER_BOUND: usize = 10000;
const DEFAULT_RECEIVER_WORKER_BOUND: usize = 10000;
const DEFAULT_BROADCASTER_WORKER_BOUND: usize = 10000;
